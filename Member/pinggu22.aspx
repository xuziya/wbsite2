<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pinggu22.aspx.cs" Inherits="Member_pinggu22" %>
    ...
    <form id="form1" runat="server">
        <div class="bg1">			
			<div class="result-box">
				...
				<div class="result-lose animated zoomInDown">
				...
				<div class="popbtn" style="top: 1050px;z-index: 99;">
					<div class="cancel"><a href="javascript:parent.close123();"><img src="img/pop/关闭.png"/></a></div>
				</div>
			</div>					
		</div>
		<script>
		    ...
		    //if (_percent > 80) { $("#zhuangtai").attr("src", "img/卓越.png"); }
		    //else if (_percent > 60 && _percent <= 80) { $("#zhuangtai").attr("src", "img/优秀.png"); }
		    //else { $("#zhuangtai").attr("src", "img/继续努力.png"); }

		    //序列帧动画
		    var num = 0,enteranimet = setInterval(function ()
		    {
		        num == 38 ? num = 0 : num++
		        $(".result-box .dtimg1").attr('src', 'img/sb/skjs_shibai-shibai_' + num + '.png')
		    }, 60);
		</script>
    </form>
