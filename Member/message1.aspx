<%@ Page Language="C#" AutoEventWireup="true" CodeFile="message1.aspx.cs" Inherits="Member_message1" %>
    ...
    <form id="form1" runat="server">
        <div class="bg1">
			<div class="head animated slideInDown clear">
				<div class="head-left"><div class="head-tit"><h2>消息</h2></div></div>
			...
			<div >
				<div class="ck animated" style="background: url(img/弹窗背景.png) no-repeat">
                    ...
                    <br />
					<div class="pop-content logs message pinggu">
                        <ul>
			...
			<div class="study-contbg">
				<div class="study-cont">
                    ...
                    <%--<p id="content"></p>--%>
					<p><iframe id="iframe" name="iframe" src="message2.aspx" frameborder="0" class="admin-iframe" style="width:100%;height:100%"></iframe></p>
				</div>
		...
		<script>
		    $(".message ul li").click(function ()
		    {
		        ...
		        $("#iframe").attr("src", "message2.aspx?id=" + $(this).attr("id"));
