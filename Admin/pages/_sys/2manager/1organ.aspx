<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/master/form.master" CodeFile="1organ.aspx.cs" Inherits="Admin_sys_manager_organ" %>
                ...
                <div class="tree_panel">
                    ...
                    <div class="tree_view">
                        ...
                        <script type="text/javascript">
                            ...
                            tree1.node_click_ajax = function (targetNode, onCom) { if (targetNode.lev >= 0) { document.getElementById("iframepage").src = "1organ_up.aspx?sole=" + targetNode.value + "&" + new Date().getTime(); } }
                        </script>
                    </div>
                </div>
            </div>
             <div class="col-lg-9 col-md-8 col-sm-7 col-xs-7"><iframe id="iframepage" width="100%" frameborder="0" scrolling="no" src="1organ_up.aspx" onload="this.style.height=this.contentWindow.document.body.scrollHeight+'px'"></iframe></div>
        </div>
    </div>
