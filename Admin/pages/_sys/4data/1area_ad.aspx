<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/master/form.master" CodeFile="1area_ad.aspx.cs" Inherits="Admin_sys_data_area_ad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <table class="table table-bordered table-hover">
        <tr>
            ...
            <td colspan="3">
                <asp:DropDownList ID="type" runat="server" class="form-select" Width="206px">
                    <asp:ListItem Value="国家">国家</asp:ListItem>
        ...
        <tr>
            <th>区域名称<span class="form-red">*</span></th>
            <td colspan="3"><asp:TextBox ID="name" runat="server" class="form-input" MaxLength="20" autocomplete="off"></asp:TextBox></td>
        </tr>
        <tr>
            <th>排序</th>
            <td colspan="3"><asp:TextBox ID="indexs" runat="server" class="form-input" Width="100px" MaxLength="4" autocomplete="off" onkeyup="this.value=this.value.replace(/[^-|\d*]/,'')" onafterpaste="harry.onlyInt(this)"></asp:TextBox></td>
        </tr>
        <tr><th>全 路 径</th><td colspan="3"><asp:TextBox ID="path" runat="server" class="form-input" MaxLength="100" autocomplete="off"></asp:TextBox></td></tr>
