<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/master/form.master" CodeFile="2menu.aspx.cs" Inherits="Admin_sys_popedom_menu" %>
        ...
        <div class="row row-col-space15">
             <div class="col-lg-3 col-md-4 col-sm-5 col-xs-5">
                 <div class="tree_panel">
                    ...
                    <div class="tree_view" >
                        <NineRays:FlyTreeView ID="TreeView1" runat="server" Width="100%" Height="100%" ImageSet="Office2003" WideCell="True" onInitializedJavascript="onInit" OnNodeEventJavascript="onNodeEvent" onpopulatenodes="TreeView1_PopulateNodes">
                        ...
                        <script type="text/javascript">
                            ...
                            tree1.node_click_ajax = function (targetNode, onCom) { if (targetNode.lev >= 1) { document.getElementById("iframepage").src = "2menu_up.aspx?sole=" + targetNode.value + "&" + new Date().getTime(); } }
                        </script>
                    </div>
                </div>
             </div>
             <div class="col-lg-9 col-md-8 col-sm-7 col-xs-7"><iframe id="iframepage" width="100%" frameborder="0" scrolling="no" src="2menu_up.aspx" onload="this.style.height=this.contentWindow.document.body.scrollHeight+'px'"></iframe></div>
        </div>
    </div>
</asp:Content>