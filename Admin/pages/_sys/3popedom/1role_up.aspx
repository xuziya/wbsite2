<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/master/form.master" CodeFile="1role_up.aspx.cs" Inherits="Admin_sys_popedom_role_up" %>

<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <table class="table table-bordered table-hover">
        <tr>
            <th width="100px">角色名称<span class="form-red">*</span></th>
        ...
        <tr><th>备注</th><td colspan="3"><asp:TextBox ID="note" runat="server" class="form-input" MaxLength="100" autocomplete="off"></asp:TextBox></td></tr>
        <tr>
            <td>&nbsp;</td>
            <td colspan="3">
                <label><input type="checkbox" id="isMain" runat="server" class="form-checkbox"/> 是否角色</label>
