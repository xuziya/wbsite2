...
public partial class Admin_sys_popedom_menu_up : System.Web.UI.Page
{
    private const string tableName = "admin_per_menu";
    ...
    //{
    //    bool result = skin.ExecuteSql("update " + tableName + " set [name]='" + name.Text + "',[indexs]='" + indexs.Text + "',[path]='" + path.Text + "',[string1]='" + string1.Text + "',[isMain]=" + (isMain.Checked ? "1" : "0") + ",[isUsed]=" + (isUsed.Checked ? "1" : "0") + ",[note]='" + note.Text + "' where sole='" + sole.InnerHtml + "'") > 0;
