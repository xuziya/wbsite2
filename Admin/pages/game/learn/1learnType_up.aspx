<%@ Page Language="C#" MasterPageFile="~/Admin/master/form.master" AutoEventWireup="true" CodeFile="1learnType_up.aspx.cs" Inherits="Admin_pages_game_learn_1learnType_up" %>
        ...
        <tr style="display:none">
            ...
            <td colspan="3">
                <asp:DropDownList ID="type" runat="server" class="form-select" Width="206px">
                    <asp:ListItem Value="类型">类型</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            <th width="100px">类型名称<span class="form-red">*</span></th>
        ...
        <tr>
            <td style="padding:20px 200px" colspan="4">
                ...
                <button class="btn btn-primary" onclick="location.href=location.href">刷&nbsp;&nbsp;新</button>
                    <button type="button" class="btn btn-primary" onclick="parent.window_close();">关&nbsp;&nbsp;闭</button>
