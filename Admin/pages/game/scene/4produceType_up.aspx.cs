...
public partial class Admin_pages_game_scene_4produceType_up : System.Web.UI.Page
{
    private const string tableName = "[produce_type]";
        ...
        if (!IsPostBack)
        {
            ...
            if (sole1 != "")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (dt.Rows[0]["string1"].ToString() != "") { Image1.ImageUrl = dt.Rows[0]["string1"].ToString(); }
                    //Image1.Visible = dt.Rows[0]["lev"].ToString() == "3" ? true : false;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        bool result = skin.ExecuteSql("update " + tableName + " set [type]='" + type.SelectedValue + "',[name]='" + name.Text + "',[popedom]='" + popedom.Text + "',[string1]='" + string1.Text + "',[string2]='',[isUsed]=" + (isUsed.Checked ? "1" : "0") + ",[indexs]='" + indexs.Text + "',[path]='" + path.Text + "',[note]='" + note.Text + "' where sole='" + sole.InnerHtml + "'") > 0;
