<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master/form.master" AutoEventWireup="true" CodeFile="3place.aspx.cs" Inherits="Admin_pages_game_scene_3place" %>
                ...
                <div class="tree_panel">
                    ...
                    <div class="tree_view">
                        ...
                        <script type="text/javascript">
                            ...
                            tree1.node_click_ajax = function (targetNode, onCom) { if (targetNode.lev >= 0) { document.getElementById("iframepage").src = "3place_up.aspx?sole=" + targetNode.value + "&" + new Date().getTime(); } }
                        </script>
                    </div>
                </div>
            </div>
             <div class="col-lg-9 col-md-8 col-sm-7 col-xs-7"><iframe id="iframepage" width="100%" frameborder="0" scrolling="no" src="3place_up.aspx" onload="this.style.height=this.contentWindow.document.body.scrollHeight+'px'"></iframe></div>
        </div>
    </div>
