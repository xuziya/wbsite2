<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master/form.master" AutoEventWireup="true" CodeFile="3place_up.aspx.cs" Inherits="Admin_pages_game_scene_3place_up" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">	
    <table class="table table-bordered table-hover">
        ...
        <tr>
            <th width="100px">触点名称<span class="form-red">*</span><br /><span class="form-tip">官方通用名称，便于识别</span></th>
