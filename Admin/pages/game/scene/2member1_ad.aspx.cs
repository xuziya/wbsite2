...
public partial class Admin_pages_game_scene_2member1_ad : AdminBasePage
{
    ...
    protected override void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //场景
            Tools.TreeNode.AddSceneByLev(TreeView1.Nodes, " where type='个人'");
            //触点
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (oper == "add")
        {
            sql.Add(@"insert into member_info values('','" + sceneSole.Value + "','" + place.SelectedValue + "','" + type + "','" + name.Text + "','" + character1.Text + "','" + sex.SelectedValue + "','" + age.SelectedValue + "','" + shuxing1.Text + "','" + shuxing2.Text + "','" + shuxing3.Text + "','" + shuxing4.Text + "','" + shuxing5.Text + "','" + shuxing6.Text + "','" + shuxing7.Text + "','" + shuxing8.Text + "','" + shuxing9.Text + "','" + shuxing10.Text + "','','','','','','','','','','',1," + (isUsed.Checked ? 1 : 0) + ",0,'','" + GetSole() + "','" + GetDateTime() + "','" + note.Text + "');");
            sql.Add(harry.Tools.Common.SetSole("member_info"));
        }
        else if (oper == "up")
        {
            sql.Add(@"update [member_info] set [sceneSole]='" + sceneSole.Value + "',[placeSole]='" + place.SelectedValue + "',[type]='" + type + "',[name]='" + name.Text + "',[character1]='" + character1.Text + "',[sex]='" + sex.SelectedValue + "',[age]='" + age.SelectedValue + "',[shuxing1]='" + shuxing1.Text + "',[shuxing2]='" + shuxing2.Text + "',[shuxing3]='" + shuxing3.Text + "',[shuxing4]='" + shuxing4.Text + "',[shuxing5]='" + shuxing5.Text + "',[shuxing6]='" + shuxing6.Text + "',[shuxing7]='" + shuxing7.Text + "',[shuxing8]='" + shuxing8.Text + "',[shuxing9]='" + shuxing9.Text + "',[shuxing10]='" + shuxing10.Text + "',isUsed=" + (isUsed.Checked ? 1 : 0) + ",[note]='" + note.Text + "' where [id]=" + ViewState["id"] + ";");
        }
