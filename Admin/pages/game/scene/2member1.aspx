<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master/table.master" AutoEventWireup="true" CodeFile="2member1.aspx.cs" Inherits="Admin_pages_game_scene_2member1" %>
        ...
        (function () {
            ...
            t1.template_tr = function (newRow, cells)
            {
                ...
                for (var columns = t1.array.columns, i = 0; i < columns.length; i++)
                {
                    ...
                    if (i == 1) { newCell = t1.getEditHtml(newCell, id, sole, value, "/Admin/pages/game/scene/2member1_ad.aspx?oper=up&id=" + id, "修改学员信息"); }
                    else if (i == 17) { newCell = t1.getUsedHtml(newCell, id, sole, value); }
