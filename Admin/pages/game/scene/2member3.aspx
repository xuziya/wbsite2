<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master/table.master" AutoEventWireup="true" CodeFile="2member3.aspx.cs" Inherits="Admin_pages_game_scene_2member3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <script type="text/javascript">
        (function () {
            ...
            t1.addColumn("200", "t1.shuxing1", "合约", "center");
            t1.addColumn("200", "t1.shuxing2", "价值", "center");
            t1.addColumn("200", "t1.shuxing3", "流量", "center");
            t1.addColumn("200", "t1.shuxing4", "资费", "center");
            t1.addColumn("200", "t1.shuxing5", "融合", "center");
            t1.addColumn("200", "t1.shuxing6", "家庭", "center");
            t1.addColumn("200", "t1.shuxing7", "权益", "center");
            t1.addColumn("200", "t1.shuxing8", "集团属性（ABCD）", "center");
            t1.addColumn("200", "t1.shuxing9", "集团星级", "center");
            t1.addColumn("200", "t1.shuxing10", "集团等级", "center");
            t1.addColumn("200", "t1.shuxing11", "集团份额", "center");
            t1.addColumn("200", "t1.shuxing12", "集团成员数", "center");
            t1.addColumn("200", "t1.shuxing13", "保拓优先级", "center");
            ...
            t1.template_tr = function (newRow, cells)
            {
                ...
                for (var columns = t1.array.columns, i = 0; i < columns.length; i++)
                {
                    ...
                    if (i == 1) { newCell = t1.getEditHtml(newCell, id, sole, value, "/Admin/pages/game/scene/2member3_ad.aspx?oper=up&id=" + id, "修改学员信息"); }
                    else if (i == 21) { newCell = t1.getUsedHtml(newCell, id, sole, value); }
