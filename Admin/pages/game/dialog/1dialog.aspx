...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <script type="text/javascript">
        (function ()
        {
            ...
            t1.pager.tname = "dialog1_info as t1 left join place_info as pi1 on t1.placeSole=pi1.sole left join [admin_per_manager] as m1 on t1.createSole=m1.id";
            ...
            t1.template_tr = function (newRow, cells)
            {
                ...
                for (var columns = t1.array.columns, i = 0; i < columns.length; i++)
                {
                    ...
                    if (i == 4) { newCell = t1.getEditHtml(newCell, id, sole, value, "/Admin/pages/game/dialog/1dialog_ad.aspx?oper=up&id=" + id, "修改对话信息"); }
