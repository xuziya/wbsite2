<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master/form.master" AutoEventWireup="true" CodeFile="2dialog_ad.aspx.cs" Inherits="Admin_pages_game_dialog_2dialog_ad" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
	...
	<div class="container-fluid">
        <table class="table table-bordered table-hover">
            <tr>
                <th>绑定客户画像<span class="form-red">*</span></th>
                <td>
