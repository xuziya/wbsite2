<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master/table.master" AutoEventWireup="true" CodeFile="3dialog.aspx.cs" Inherits="Admin_pages_game_dialog_3dialog" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <script type="text/javascript">
        (function ()
        {
            ...
            t1.addSearch("dropdown", "关联触点", "t1_placeSole", "=");
            t1.addSearch("select", "使用状态", "t1_isUsed", "=");
            t1.addSearch("time", "添加时间", "t1_createDate");
            t1.pager.tname = "dialog3_info as t1 left join produce_info as pi1 on t1.produceSole=pi1.sole left join [admin_per_manager] as m1 on t1.createSole=m1.id";
            t1.addColumn("60", "t1.id", "编号", "center", "0");
            t1.addColumn("250", "pi1.name=pi1_name", "产品名称", "center");
            ...
            t1.template_tr = function (newRow, cells)
            {
                ...
                for (var columns = t1.array.columns, i = 0; i < columns.length; i++)
                {
                    ...
                    if (i == 4) { newCell = t1.getEditHtml(newCell, id, sole, value, "/Admin/pages/game/dialog/3dialog_ad.aspx?oper=up&id=" + id, "修改学员信息"); }
	...
	<div id="treePanel1" style="display:none">
        ...
        <script type="text/javascript">
            var tree1 = new TreeDropDown("treePanel1", "t1_placeSole1", "t1_placeSole");
