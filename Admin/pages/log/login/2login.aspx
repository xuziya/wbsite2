<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/master/table.master" CodeFile="2login.aspx.cs" Inherits="Admin_pages_sys_log_2login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <script type="text/javascript">
        (function ()
        {
            var t1 = new Table();
            t1.title = "<%=GetPath() %>";
            t1.addSearch("text", "经理姓名", "m1_name", "like", "100px");
            t1.addSearch("text", "经理账号", "m1_uid", "like", "100px");
            t1.addSearch("text", "登录ip", "t1_loginIp", "like", "100px");
            t1.addSearch("time", "登录时间", "t1_createDate");
            t1.pager.tname = "[member_log_login] as t1 left join client_financial as m1 on t1.createSole=m1.sole left join [admin_organ] as o1 on m1.organSole=o1.sole";
