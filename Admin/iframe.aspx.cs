...
public partial class Admin_iframe : AdminBasePage
{
    ...
    private static string[] css = { "fa-home", "fa-file-text-o", "fa-cog", "fa-file-text-o", "fa-bar-chart" };
    ...
    public void GetLeftMenu()
    {
        ...
        for (int i = 0; i < dt1.Rows.Count; i++)
        {
            ...
            {
                html.Append("       <li><a target='iframe' href='" + dt2.Rows[j]["menuLinkUrl"] + "' onclick='alert(" + dt2.Rows[j]["menuLinkUrl"] + ")'>" + dt2.Rows[j]["menuName"] + "</a> </li>");
            }
            html.Append("       </ul>");
            html.Append("   </div>");
            html.Append("</li>");
